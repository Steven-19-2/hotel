...
#     r = client.post("/rooms/", json=payload, headers=headers)
#     rid = r.json()["id"]

#     # Update room
#     update_payload = {"number": "103", "type": "single", "price": 100, "capacity": 1}
#     r2 = client.put(f"/rooms/{rid}", json=update_payload, headers=headers)
#     assert r2.status_code == 200
...
#     # Delete room
#     r2 = client.delete(f"/rooms/{rid}", headers=headers)
#     assert r2.status_code == 200
